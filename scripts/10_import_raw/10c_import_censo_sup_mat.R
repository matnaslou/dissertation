...
cols <- c(
  "NU_ANO", "CO_PESSOA_FISICA", "CPF_MASC", "CO_IES", "TP_CATEGORIA_ADMINISTRATIVA",
  "CO_CURSO", "IN_INGRESSO_ENEM"
)
...
import_clean_cs <- function(yr) {
  ...
  path_out <- fs::path(output, glue::glue("cs_{yr}_mat.csv"))
